...
**Traccia:**
Quale sarà il valore finale della variabile `somma` al termine dell'esecuzione del seguente codice C++, se la variabile `numero` viene inizializzata a **4519**? Descrivi brevemente cosa fa il ciclo.
...
**Funzione del Ciclo:**
Il ciclo calcola la **somma delle cifre** del numero iniziale (4 + 5 + 1 + 9 = 19).
